...
| [![coineal](undefined)](https://www.coineal.com)                                                                                                                                                 | coineal            | [Coineal](https://www.coineal.com)                                                      | 1   | [API](https://www.coineal.com/static-page/api/en_US/api.html)                                |                                                                                                                             |                                                                              |
...
| [![hotbit](undefined)](https://www.hotbit.io)                                                                                                                                                    | hotbit             | [Hotbit](https://www.hotbit.io)                                                         | 1   | [API](https://github.com/hotbitex/hotbit.io-api-docs/blob/master/rest_api_en.md#marketlist)  |                                                                                                                             |                                                                              |
...
| [![wavesexchange](https://user-images.githubusercontent.com/1294454/84547058-5fb27d80-ad0b-11ea-8711-78ac8b3c7f31.jpg)](https://waves.exchange)                                                  | wavesexchange      | [Waves.Exchange](https://waves.exchange)                                                | *   | [API](https://docs.waves.exchange)                                                           | [![CCXT Certified](https://img.shields.io/badge/CCXT-Certified-green.svg)](https://github.com/ccxt/ccxt/wiki/Certification) |                                                                              |
| [![wbf](undefined)](https://www.wbf.live)                                                                                                                                                        | wbf                | [Wbf](https://www.wbf.live)                                                             | 1   | [API](https://github.com/wbfex/api/blob/master/api/us_en/api_doc_en.md)                      |                                                                                                                             |                                                                              |
...
* jsDelivr: https://cdn.jsdelivr.net/npm/ccxt@1.33.57a/dist/ccxt.browser.js
* unpkg: https://unpkg.com/ccxt@1.33.57a/dist/ccxt.browser.js

CDNs are not updated in real-time and may have delays. Defaulting to the most recent version without specifying the version number is not recommended. Please, keep in mind that we are not responsible for the correct operation of those CDN servers.

```HTML
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/ccxt@1.33.57a/dist/ccxt.browser.js"></script>
```
